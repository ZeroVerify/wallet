...
/**
 * Stores an encrypted credential in IndexedDB
 */
...
/**
 * Retrieves and decrypts all stored credentials
 */
...
/**
 * Retrieves and decrypts a specific credential by ID
 */
...
/**
 * Clears all credentials from IndexedDB
 */
